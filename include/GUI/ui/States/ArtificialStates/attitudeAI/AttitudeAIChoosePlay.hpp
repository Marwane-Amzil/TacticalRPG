...
class AttitudeAIChoosePlay : public PlayState
{
public:
	explicit AttitudeAIChoosePlay(StateMachine& machine, sf::RenderWindow& window, gui::World& world, utils::TextureManager& texture_manager, const bool replace = true);
