...
#ifndef __HealerTemp_H__
#define __HealerTemp_H__

#include <Skills/MagicalSkill.hpp>

class HealerTemp : public MagicalSkill
{
public:
	...
	*/
	explicit HealerTemp(int multiplier, int range, Character* character,Effect* effect = nullptr);
	
	/**
	* @brief Fireball destructor. Explicitly defaulted (~Fireball() = default)
	*/
	inline ~HealerTemp() noexcept = default;
