...
class NetworkChoosePlay : public NetworkPlayState
{
public:
	explicit NetworkChoosePlay(StateMachine& machine, sf::RenderWindow& window, gui::World& world, utils::TextureManager& texture_manager, const bool replace = true);
