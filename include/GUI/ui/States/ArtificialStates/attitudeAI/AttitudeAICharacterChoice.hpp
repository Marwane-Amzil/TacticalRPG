...
class AttitudeAICharacterChoice : public PlayState
{
public:
	explicit AttitudeAICharacterChoice(StateMachine& machine, sf::RenderWindow& window, gui::World& world, utils::TextureManager& texture_manager, const bool replace = true);
